...
public class TouchHandler_ : MonoBehaviour
{
    #region PUBLIC_MEMBERS

    public Transform augmentationObject;

    [HideInInspector] public bool enableRotation;
    ...
    void Update()
    {
        ...
        if (Input.touchCount == 2)
        {
            ...
            {
                this.augmentationObject.localEulerAngles =
                    this.cachedAugmentationRotation - new Vector3(0, angleDelta * 3f, 0);
            }
            ...
            if (this.enableRotation && this.enablePinchScaling)
            {
                ...
                this.augmentationObject.localScale =
                    new Vector3(scaleAmountClamped, scaleAmountClamped, scaleAmountClamped);
            }
        }
